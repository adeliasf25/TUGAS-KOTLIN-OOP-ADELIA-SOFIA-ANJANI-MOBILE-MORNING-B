...
fun main() {
     ...
     *
     */
    class MorningClass(val memberName: String) {
        fun jalan(times: Int) {
            println("$memberName -> jalan $times kali")
        }

        fun lari(times: Int) {
            println("$memberName -> lari $times kali")
        }

        fun makan(times: Int) {
            println("$memberName -> makan $times kali")
        }

        fun minum(times: Int) {
            println("$memberName -> minum $times kali")
        }

        fun lompat(times: Int) {
            println("$memberName -> lompat $times kali")
        }

        fun duduk(times: Int) {
            println("$memberName -> duduk $times kali")
        }
    }

    fun main() {
        // Membuat objek untuk anggota Lumos
        val lumos = MorningClass("Lumos")

        // Memanggil fungsi-fungsi sesuai dengan challenge
        lumos.jalan(2)
        lumos.lari(1)
        lumos.makan(5)
        lumos.minum(2)
