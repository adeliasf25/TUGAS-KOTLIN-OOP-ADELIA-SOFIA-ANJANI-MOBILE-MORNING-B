 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf<String>("Jovian", "Hakim")
...
fun main() {
    ...
    groupDetail("Lumos", listOf("Lintang Luthfiantoni", "Mutia Nandika", "Asfia Apriani", "Lustiara Mega", "Vika Dwi Nur", "Ali Askari", "Aditya Mufid", "Adelia Sofia", "Sapitri", "Khaeril Maswal", "Abdus Salam"), "Morning")
}